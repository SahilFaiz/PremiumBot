...
async def forcedjoined(c: Client, m: Message, tryag: str = ""):
    ...
    with suppress(UserIsBlocked):
        try:
            ...
            await m.reply_text(
                text="<b> » 🗃️ 𝖳𝗈 𝖺𝖼𝖼𝖾𝗌𝗌 𝖿𝗂𝗅𝖾𝗌,/n🌟 > 𝗃𝗈𝗂𝗇 𝗍𝗁𝖾 5 𝖼𝗁𝖺𝗇𝗇𝖾𝗅𝗌 𝗅𝗂𝗌𝗍𝖾𝖽 𝖻𝖾𝗅𝗈𝗐 < . 𝖠𝖿𝗍𝖾𝗋 𝗃𝗈𝗂𝗇𝗂𝗇𝗀, 𝗍𝗁𝖾 𝖻𝗈𝗍 𝗐𝗂𝗅𝗅 𝗉𝗋𝗈𝗏𝗂𝖽𝖾 𝗍𝗁𝖾 𝖿𝗂𝗅𝖾𝗌./n»  🚀 𝖭𝖾𝖾𝖽 𝖿𝗂𝗅𝖾𝗌 𝖿𝖺𝗌𝗍? 𝖩𝗈𝗂𝗇 𝖿𝗈𝗅𝖽𝖾𝗋👇/n>>> https://telegram.me/addlist/oP5DNuM5kvtlYTc9 <<<  </b>",
                reply_markup=mark,
            )
            return 0
        except RPCError:
